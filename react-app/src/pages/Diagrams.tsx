...
const DIAGRAMS: Diagram[] = [
  ...
  // ── Secure ────────────────────────────────────────────────────────────────
  {
    ...
    nodes: [
      ...
      { id: 'group',  label: 'IAM Group\n(users)',   x: 110, y: 380, color: '#7c3aed' },
      { id: 'policy', label: 'IAM Policy\n(JSON)',   x: 370, y: 240, color: '#475569' },
      { id: 'role',   label: 'IAM Role\n(service)',  x: 630, y: 100, color: '#dc2626' },
      { id: 'aws',    label: 'AWS\nServices',        x: 630, y: 380, color: '#FF9900' },
    ],
    edges: [
      { from: 'user',  to: 'group',  label: 'member of' },
      { from: 'group', to: 'policy', label: 'attached' },
      { from: 'user',  to: 'policy', label: 'direct attach', labelFlip: true },
      { from: 'role',  to: 'policy', label: 'attached' },
